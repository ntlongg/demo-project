...
const UploadProduct = ({ 
  ...
  const handleUploadProduct = async(e) => {
    ...
    const uploadImageloudinary = await uploadImage(file)
    setData((preve)=>{
      return{
        ...preve,
        productImage : [ ...preve.productImage,uploadImageloudinary .url]
      }
    })
  }
      ...
      <div className='fixed w-full  h-full bg-slate-200 bg-opacity-35 top-0 left-0 right-0 bottom-0 flex justify-center items-center'>
          ...
          <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden '>
              ...
              <form className='grid p-4 gap-2 overflow-y-scroll h-full pb-5' onSubmit={handleSubmit}>
                                  ...
                                  return(
                                    <div className='relative group'>
                                        <img 
                                          ...
                                          <div className='absolute bottom-0 right-0 p-1 text-black bg-green-400 hover:text-white hover:bg-red-500 rounded-full hidden group-hover:block cursor-pointer' onClick={()=>handleDeleteProductImage(index)}>
                                            <MdDelete/>  
                                          </div>
                                    </div>
                  ...
                  <label htmlFor='description' className='mt-3 h-full'>Description :</label>
                  <textarea 
